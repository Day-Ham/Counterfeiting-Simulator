...
using DaeHanKim.Reflection;
using UnityEditor;
using UnityEngine;

namespace DaeHanKim.Utilities.Editor
{
    ...
    public class ShowIfPropertyDrawer : PropertyDrawer
    {
        ...
        {
            return CanShow(property) ? EditorGUI.GetPropertyHeight(property, label, true) : 0f;
        }
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            if (CanShow(property))
            {
                ...
                GUI.enabled = showIfAttribute.AsEnabled;
